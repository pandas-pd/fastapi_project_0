...
class Endpoint():
    ...
    def get_projects(token : HTTPAuthorizationCredentials = Depends(auth_schema)):
    ...
    def delete_project(body: Projects.delete_project, response: Response, token : HTTPAuthorizationCredentials = Depends(auth_schema)):
